...
<body class="tempate-two">
                ...
                <div class="col-lg-10 col-sm-9 col-xs-6 col-7">
                    <div class="main_nav ml-auto">
                        ...
                        <nav id="primary_navigation" class="site_navigation">
                            ...
                            <a href="#joiningPopup" class="get_quote btn blue_gradient open-popup-link">Get a quote</a>
    ...
    <!-- portfolio Section -->
    <section class="portfolio_tab_sec bg_light_gray" id="portfolio">
        <div class="container">
            <div class="sec_header text-center">
                <h2 class="sec_heading wow fadeInLeft"><span>OUR LATEST Works</span>Our Portfolio Designs</h2>
        ...
        <div class="container-fluid">
            <div class="portfolio_tabs">
                <ul class="tabs_list text-center wow fadeInUp" id="filters">
                    <li><a href="#!" class="filter active" data-filter=".designs, .development, .seo, .marketing">All</a></li>
                    <li><a href="#!" class="filter" data-filter=".designs">Designs</a></li>
                    <li><a href="#!" class="filter" data-filter=".development">Development</a></li>
                    <li><a href="#!" class="filter" data-filter=".seo">SEO</a></li>
                    <li><a href="#!" class="filter" data-filter=".marketing">Marketing</a></li>
                </ul>
                <div class="portfolio_list wow fadeInUp">
                    <div id="portfoliolist">
                            <div class="portfolio_item portfolio designs" data-cat="designs" style="display: inline-block;">
                                <a href="assets/images/template-one/portfolio-1.jpg">
                                    <img src="assets/images/template-one/portfolio-1.jpg" alt="portfolio">
                                    <div class="p_caption">
                            ...
                            <div class="portfolio_item portfolio designs" data-cat="designs"  style="display: inline-block;">
                                <a href="assets/images/template-one/portfolio-2.jpg">
                                    <img src="assets/images/template-one/portfolio-2.jpg" alt="portfolio">
                                    <div class="p_caption">
                                        <div class="plus_icon"></div>
                                        <h4>Our Design 1</h4>
                                        <p>Check Our Work</p>
                            ...
                            <div class="portfolio_item portfolio development" data-cat="development"  style="display: inline-block;">
                                <a href="assets/images/template-one/portfolio-3.jpg">
                                    <img src="assets/images/template-one/portfolio-3.jpg" alt="portfolio">
                                    <div class="p_caption">
                                        <div class="plus_icon"></div>
                                        <h4>Our Design 1</h4>
                                        <p>Check Our Work</p>
                            ...
                            <div class="portfolio_item portfolio seo" data-cat="seo"  style="display: inline-block;">
                                <a href="assets/images/template-one/portfolio-4.jpg">
                                    <img src="assets/images/template-one/portfolio-4.jpg" alt="portfolio">
                                    <div class="p_caption">
                                        <div class="plus_icon"></div>
                                        <h4>Our Design 1</h4>
                                        <p>Check Our Work</p>
                            ...
                            <div class="portfolio_item portfolio marketing" data-cat="marketing"  style="display: inline-block;">
                                <a href="assets/images/template-one/portfolio-5.jpg">
                                    <img src="assets/images/template-one/portfolio-5.jpg" alt="portfolio">
                                    <div class="p_caption">
                                        <div class="plus_icon"></div>
                                        <h4>Our Design 1</h4>
                                        <p>Check Our Work</p>
                            ...
                            <div class="portfolio_item portfolio marketing" data-cat="marketing"  style="display: inline-block;">
                                <a href="assets/images/template-one/portfolio-6.jpg">
                                    <img src="assets/images/template-one/portfolio-6.jpg" alt="portfolio">
                                    <div class="p_caption">
                                        <div class="plus_icon"></div>
                                        <h4>Our Design 1</h4>
                                        <p>Check Our Work</p>
    ...
    <section class="service_sec" id="service">
        <div class="container">
            ...
            <div class="servics_list">
                        ...
                        <div class="service_item">
                            ...
                            <div class="service_content">
                                ...
                                <p>Lorem ipsum dolor sit amet. Con eleifend sem sed dictum mattis sectetur elit. Nulla
                                    convallis pul.</p>
                                <a href="#" class="btn blue_gradient">Read More</a>
                            </div>
                        </div>
                    </div>
                ...
                <a href="#" class="btn browse_btn blue_gradient wow slideInUp" data-wow-duration="1.75s"
                    ...
                    <div class="col-lg-4">
                        <div class="pricing_item">
                            ...
                            <div class="p_i_middle">
                                ...
                                <a href="#" class="btn blue_gradient">Buy Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="contact-form-area wow fadeInRight">
                            <form method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            <input class="form-control" type="text" placeholder="Full Name Here" name="nombre">
                                            <i class="fa fa-user"></i>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            <input class="form-control" type="email" placeholder="Email Here" name="email">
                                            <i class="fa fa-envelope-open"></i>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            <input class="form-control" type="text" placeholder="Phone No" name="tel">
                                            <i class="fa fa-phone"></i>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            <input class="form-control" type="text" placeholder="Subject" name="asunto">
                                            <i class="fa fa-edit"></i>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="input-box">
                                            <textarea class="form-control" name="msg" id="#" cols="30" rows="10"
          ...
          <div class="get_quote_form">
              <form method="post">
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              <input type="text" class="form-control" name="tel2" placeholder="Enter Phone No.">
                          </div>
                      </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="form-group">
                      <textarea class="form-control" placeholder="Enter Your Message" name="msg2"></textarea>
                  </div>
